Event.SignUp.Form = function() {
  this.fields = [];

  this.initDialog();
};

Event.SignUp.Form.prototype.addField = function(field) {
...
Event.SignUp.Form.prototype.create = function() {
//        name: 'Questions',
...
//      help: 'These questions will show up as someone signs up.'
  ...
  this.dialog.empty();
  this.dialog.dialog("option", "title", 'Add Questions to Sign Up');
...
Event.SignUp.Form.prototype.initDialog = function() {
  this.dialog = $('<div/>');
  this.dialog.dialog(
    {
      modal: true,

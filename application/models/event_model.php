<?php
  class Event_model extends CI_Model {
    ...
    private function format(&$event) {
      $event['start_time'] = date('h:i a', strtotime($event['time_start']));
      $event['end_time']   = date('h:i a', strtotime($event['time_end']));
      $event['start_date'] = date('m/d/Y', strtotime($event['time_start']));
      $event['end_date']   = date('m/d/Y', strtotime($event['time_end']));
